...
for m in range(0,25):
	...
	#print(m)
	#print(var_res)
	ta, tai, taf, amp = detect_cusum(Doc_list_cou, var_res, mean/1.25, True, False)
	print(tai,taf)
	# print(data_merge1)
	event_list = []
...
event_df.to_csv('Event_Document_Map_k1.csv', encoding='utf-8')
topic_doc_df.to_csv('Topic_Document_Event_Map_k1.csv', encoding='utf-8')
...
df_empty.to_csv('Document_Entity_k1.csv', encoding='utf-8')
topic_time_Doc_df.to_csv('Topic_Time_Doc_k1.csv', encoding='utf-8')